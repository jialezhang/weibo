   ...
   if(empty($_POST["pass"])){
    ...
    $errors[]="you forget gender";
	  ...
	  require_once('connect.php');
       ...
       else{mysql_select_db("simple", $dbc);
           	$q="INSERT INTO user (email,pass,nickname,age,gender) VALUES ('$el','$pd','$ne','$ae','$gr')";
			$r=mysql_query($q,$dbc);
			if($r){
			echo"success";}
			mysql_close($dbc);
...
<p>E-mail:<input type=text   name=email      size=20      value="<?php if(isset($_POST['email']))echo $_POST["email"];?>"/></p>
