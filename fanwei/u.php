...
$actions = array('index','me','book','fav','bao','photo','topic','talk','atme','comments','all','maybe','ask','follow','fans','feed','attention','message','sendmsg','msgview','exchange','album','friends');
