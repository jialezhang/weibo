        ...
        if (autoLayout.pageNum <= 10) {
            ...
            if (a > e) {
                ...
                if (autoLayout.autoTimer !== null) {
                    ...
                    autoLayout.init(d +"&p="+ autoLayout.pageNum);
                    autoLayout.pageNum++;
