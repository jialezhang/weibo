...
(function($){
	...
	$.Head_Search=function(keyword)
	{
		
		var key = encodeURIComponent(keyword);
		var url = "";
		if(URL_MODEL == '1')
			url = SITE_PATH+"book/share?kw="+key;
		else
			url = SITE_PATH+"book.php?action=share&kw="+key;
	...
	$.checkForm = function()
	{
		if($("#thumb0").css('display') == 'block' && $(".albumid").val() != "" && $.trim($("#addTitle0").val()) != "")	
		{
